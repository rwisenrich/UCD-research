# 05 — Biological Organization

UCD treats biological organization as a downstream many-body/material organization problem rather than introducing a separate fundamental force called life.
...
## Life as active self-maintenance

The historical UCD interpretation identifies living organization with active maintenance of boundaries, stored instructions, energy flow, repair, reproduction, and internal/external discrimination.
...
This is a systems-level description, not a derivation of life from H504 alone.
...
\to
\text{membrane/Ca}^{2+}/\text{synaptic transduction}
\to
\text{quantum witness}
\to
\text{E/I network dynamics}
\to
\text{recurrent memory/computation}
\to
